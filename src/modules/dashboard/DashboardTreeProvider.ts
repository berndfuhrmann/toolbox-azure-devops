...
import { DashboardTreeProviderResolver } from "../../generated/treeProviderResolvers";
...
export class DashboardTreeProvider extends AbstractTreeProvider {
  #resolver: DashboardTreeProviderResolver;

  protected sortTreeItems(treeItems: AbstractTreeItem<any>[], parent: AbstractTreeItem<any> | undefined): void {}

  constructor(
    @inject(types.DashboardTreeProviderResolver)
    resolver: DashboardTreeProviderResolver,
  ) {
    super();
